...
class ComposerAutoloaderInit77024f0f55cd26d2d2e7c5483aa34fdf
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit77024f0f55cd26d2d2e7c5483aa34fdf::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire77024f0f55cd26d2d2e7c5483aa34fdf($fileIdentifier, $file);
        }
...
function composerRequire77024f0f55cd26d2d2e7c5483aa34fdf($fileIdentifier, $file)
{
